...
class Hand {
    ...
    setTime() {
        ...
        startP = this.rawLog.indexOf("-- ending hand #") + 16;
        startP = this.rawLog.indexOf('"created_at":"', startP) + 14;
        endP = this.rawLog.indexOf('"', startP);
        this.mstime = this.rawLog.substring(startP, endP);
